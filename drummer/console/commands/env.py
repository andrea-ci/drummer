...
class EnvInit():
    ...
    def execute(self, args):
        ...
        # task folder
        TASK_DIR = 'tasks'
        TASK_DIR_PATH = path.abspath(path.join(ROOT_DIR, TASK_DIR))

        # config folder
        CONFIG_DIR = 'config'
        CONFIG_DIR_PATH = path.abspath(path.join(ROOT_DIR, CONFIG_DIR))
        CONFIG_FILE = 'drummer-config.yml'
        TASK_FILE = 'drummer-tasks.yml'

        # database folder and filepath
        DATABASE_DIR = 'database'
        DATABASE_DIR_PATH = path.abspath(path.join(ROOT_DIR, DATABASE_DIR))
